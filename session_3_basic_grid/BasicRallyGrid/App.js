...
Ext.define('CustomApp', {
 ...
 //             var selectedIterRef = console.log('show record', combobox.getRecord().get('_ref'));
 //             this._loadData();
 ...
 //             this._loadData();
    ...
    _loadData: function() {
      ...
      console.log('severity value', selectedSeverityValue);
      ...
      // if store exsists load new data
      if (this.defectStore) {
    ...
    _createGrid: function(myStoryStore) {
      ...
      this.myGrid = Ext.create('Rally.ui.grid.Grid', {
        ...
        columnCfgs: [         // Columns to display; must be the same names specified in the fetch: above in the wsapi data store
          'FormattedID', 'Name', 'ScheduleState', 'Severity', 'Iteration'
        ]
      });
